...
function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    setInfo('Account created successfully! Redirecting to home...');
    setTimeout(() => {
      navigate('/');
    }, 900);
  };
      ...
      <div style={{ width: '100%', maxWidth: 500 }}>
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          ...
          <p style={{ color: '#b3b3b8', margin: 0, fontSize: '1rem' }}>
            Create an account to save recipes, favorites, and personalize your vault.
          </p>
        </div>
        ...
        <p style={{ color: '#b3b3b8', marginTop: 18, textAlign: 'center' }}>
          ...
          <Link to="/login" style={{ color: '#ffb86c', textDecoration: 'none', fontWeight: 700 }}>
            Login here
          </Link>
        </p>
      </div>
